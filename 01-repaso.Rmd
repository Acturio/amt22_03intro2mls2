...
knitr::include_graphics("img/01-repaso/train-and-test.png")
```

2.  **Elegir un algoritmo para ejecutarlo en el conjunto de datos de entrenamiento**: 
...
3.  **Entrenamiento del algoritmo para crear el modelo**: 
