...
Vale la pena hacer un breve repaso de lo que hemos estudiado hasta el momento.
...
knitr::include_graphics("img/03-svm/01_inseparable_classes.png")
```
...
knitr::include_graphics("img/03-svm/02_maximum_margin_classifier.png")
```
...
```{r, fig.align='center', out.height='380pt', out.width='900pt',echo=F}
knitr::include_graphics("img/03-svm/03_support_vector_classifier.png")
```
...
```{r, fig.align='center', out.height='380pt', out.width='900pt',echo=F}
knitr::include_graphics("img/03-svm/04_polinomial_kernel_plot.png")
```
...
```{r, fig.align='center', out.height='380pt', out.width='900pt',echo=F}
knitr::include_graphics("img/03-svm/05_kernel_polinomial_plot2.png")
```
...
knitr::include_graphics("img/03-svm/06_kernels.png")
```
...
knitr::include_graphics("img/03-svm/3-15-1-poli.png")
```
...
```{r, fig.align='center', out.height='400pt', out.width='400pt',echo=F}
knitr::include_graphics("img/03-svm/svm_radial.png")
```
