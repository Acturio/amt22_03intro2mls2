...
svm_classification_best_1se_model <- select_by_one_std_err(svm_tune_class_result, metric = "roc_auc", "roc_auc")
...
svm_classification_final_model <- svm_class_workflow %>%
  finalize_workflow(svm_classification_best_1se_model) %>%
